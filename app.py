...
def main():
    ...
    Condition1 = st.selectbox("Condition 1", [
        'Norm', 'Feedr', 'Artery', 'RRAn', 'RRAe', 'RRNn', 'RRNe', 'PosN', 'PosA'
    ])
    ...
    Exterior1st = st.selectbox("Exterior Covering 1", [
        'VinylSd', 'MetalSd', 'Wd Sdng', 'HdBoard', 'BrkFace', 'CemntBd', 'Plywood',
        'WdShing', 'Stucco', 'AsbShng', 'Stone', 'ImStucc', 'AsphShn', 'CBlock'
    ])
    Exterior2nd = st.selectbox("Exterior Covering 2", [
        'VinylSd', 'MetalSd', 'Wd Sdng', 'HdBoard', 'BrkFace', 'CemntBd', 'Plywood',
        'WdShing', 'Stucco', 'AsbShng', 'Stone', 'ImStucc', 'AsphShn', 'CBlock', 'Other'
    ])
    ...
    Foundation = st.selectbox("Foundation Type", ['PConc', 'CBlock', 'BrkTil', 'Slab', 'Stone', 'Wood'])
    ...
    GarageType = st.selectbox("Garage Type", ['Attchd', 'Detchd', 'BuiltIn', 'Basment', 'CarPort', '2Types', 'None'])
    ...
    SaleType = st.selectbox("Sale Type", ['WD', 'New', 'COD', 'ConLD', 'ConLI', 'ConLw', 'Con', 'Oth'])
    ...
    # --- Sliders for quality and condition ---
